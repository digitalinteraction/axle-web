...
//console.log('Bootload...'); await newStreamer.bootloadCommand(); throw new Error("Bootloading");
        ...
        send.addEventListener('click', async () => {
          // TODO: Send manual command
          const command = prompt('Enter manual command:');
          if (command != null && command != '') {
            await newStreamer.manualCommand(command);
          }
        });
        ...
        special.addEventListener('click', async () => {
          // TODO: Special command (bootload)
          await newStreamer.bootloadCommand();
        });
