...
// -- ProtocolError	2	- There was a GATT communication protocol error.
  ...
  static async create(alternativeDevice) {
    if (location.protocol === 'http:') {
      log('WARNING: WebBluetooth may not supported for HTTP protocol -- you may need to use file:, https:, or content:');
    }
    ...
    // TODO: Use `alternativeDevice` to allow finding a bootloader device, rather than just UART
  ...
  //        { services: [this.uuidServiceUart] },
    ...
    if (alternativeDevice) {
      // DFU service is block-listed, with seemingly no way for the user to override, 
      // even though it requires device interaction in this case. :-(
      //   https://github.com/WebBluetoothCG/registries/blob/master/gatt_blocklist.txt
      filters.optionalServices.push(this.uuidServiceDfu);
    }

    let bluetoothDevice = await navigator.bluetooth.requestDevice(filters);
...
Device.uuidServiceDfu                 = '00001530-1212-efde-1523-785feabcd123';
Device.uuidCharacteristicControlPoint = '00001531-1212-efde-1523-785feabcd123';
Device.uuidCharacteristicPacket       = '00001532-1212-efde-1523-785feabcd123';
Device.uuidCharacteristicRevision     = '00001534-1212-efde-1523-785feabcd123';
